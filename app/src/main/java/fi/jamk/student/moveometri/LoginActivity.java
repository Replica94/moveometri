...
public class LoginActivity extends AppCompatActivity {
    ...
    private TripConnection tripConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterCheckBox = (CheckBox) findViewById(R.id.register_account_check_box);
        ...
        tripConnection = TripConnection.getInstance(this);
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, mRegisterCheckBox.isChecked());
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (mRegister)
            {
                id = tripConnection.registerSync(mEmail, mPassword);
            }
            else
            {
                id = tripConnection.loginSync(mEmail, mPassword);
            }
